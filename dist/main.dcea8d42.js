...
var hashMap = sites || [{ logo: 'B', url: 'https://www.bootcdn.cn/' }, { logo: 'C', url: 'https://www.caniuse.com/' }, { logo: 'D', url: 'https://developer.mozilla.org/' }, { logo: 'F', url: 'https://www.figma.com/' }, { logo: 'G', url: 'https://github.com/' }, { logo: 'I', url: 'https://www.iconfont.cn/' }, { logo: 'J', url: 'https://jquery.com/' }, { logo: 'V', url: 'https://cn.vuejs.org/' }];
...
var render = function render() {
    ...
    hashMap.forEach(function (item, i) {
        $('<li><div class="site">\n            <div class="logo">' + item.logo + '</div>\n            <div class="link">' + simplifyUrl(item.url) + '</div>\n            <div class="close">\n                <svg class="icon">\n                    <use xlink:href="#icon-close"></use>\n                </svg>\n            </div>\n        </div></li>').insertBefore($last).on('click', function () {
...
$('.siteList').on('click', '.close', function (e) {
    e.stopPropagation();
